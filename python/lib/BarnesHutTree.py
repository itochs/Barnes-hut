...
def calculate_repulsive_pairs(nodes: list[Node], threshold: float) -> list[tuple[Node, Node]]:
    """
    ...
    def _find_pairs_recursive(tree_node: BarnesHutTree, current_node: Node):
        ...
        dist = math.hypot(particle_pos.x - gravity_point.x, particle_pos.y - gravity_point.y)
